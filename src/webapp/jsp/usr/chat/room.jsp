...
<section>
    <div class="container px-3 mx-auto">
        ...
        <form onsubmit="ChatMessageSave__submitForm(this); return false;" method="POST" action="/usr/chat/writeMessage/${room.getId()}">
        ...
        <ul class="mt-5">
            <c:forEach items="${messages}" var="message">
                <li class="flex">
                    <a class="flex-grow hover:underline hover:text-[red]" href="/usr/chat/detail/free/${message.id}">${message.body}</a>
                </li>
            </c:forEach>
        </ul>
